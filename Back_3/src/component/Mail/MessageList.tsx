...
type Props = {
    ...
    // ✅ پوشه‌ای که باید نمایش داده شود
    folder?: MailFolder;

    // ✅ اگر داده شود، از همین‌ها نمایش می‌دهد و دیگر API نمی‌زند
    messages?: MailMessage[];

    // ✅ اگر بخواهی دستی خاموش/روشن کنی

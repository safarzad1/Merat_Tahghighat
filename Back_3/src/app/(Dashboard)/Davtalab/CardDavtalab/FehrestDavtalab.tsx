...
import { RefreshCcw, Send, DownloadCloud, FilterIcon, FilterXIcon, UserCheck2Icon, UserCheck2, User2, ShieldCheck } from "lucide-react";
                        ...
                        <DynamicTable
                            ...
                            headerActions={[
                                ...
                                },
                                {
                                    ...
                                    className: "bg-green-700 hover:bg-orange-600 cursor-pointer",
                                    onClick: () => {
                                        setPage(1);
                                        setFilterValue(2);
                                    },
                                },
                                {
                                    ...
                                    className: "bg-black hover:bg-orange-600 cursor-pointer",
                                    onClick: () => {
                                        setPage(1);
                                        setFilterValue(0);
                                    },
                                },
                                {
                                    ...
                                    onClick: () => {
                                        setPdfFileName("Report_14041203.pdf");
                                        setPdfTitle("فهرست داوطلبان میاندوره ای اول مجلس دوازدهم"); // ✅ این مهمه

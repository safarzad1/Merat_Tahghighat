...
export async function POST(req: NextRequest) {
    ...
    const { messageId, fileName, captionName, mMType, userId } = body;
    ...
    try {
        ...
        const result = await pool
            ...
            .input("CaptionName", sql.NVarChar(200), captionName)
            .input("MMType", sql.NVarChar(200), mMType)
            .input("CreateUserId", sql.BigInt, userId)
            .execute("Mail.SP_InsertMessageFiles");

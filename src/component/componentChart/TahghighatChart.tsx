...
export default function FileStatusChart({ mahal }: FileStatusChartProps) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const response: ApiResponse = await Get_AmarTahghight_Shahrestan(mahal);
                ...
                <div className="bg-white p-4 shadow-lg rounded-lg border border-gray-200">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="text-gray-600">
                            تعداد پرونده: <span className="font-bold text-blue-600">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mb-3">
                        <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-600">
                                مجموع: {chartData.reduce((sum, item) => sum + item.CountParvandeh, 0).toLocaleString('fa-IR')} پرونده
                            </span>
                        </div>

...
import { Maximize2, RotateCcw, Minus, Plus, Loader2, Search, X, FolderOpen, Camera } from "lucide-react";
import {
...
export default function PageLayout({
    ...
    const loadKholasehIntoBoxByTag = async (tagId: number) => {
        ...
        try {
            ...
            // اگر آرایه بود، جدیدترین را بگیر (آخرین)
            const arr =
    ...
    // ✅ مهم: لیست پایین فقط با تغییر پرونده/دوره لود شود (نه activeTag)
    useEffect(() => {
        loadKholasehList();
    ...
    const handleSubmit = async () => {
        ...
        // بعد از ثبت: لیست پایین رو آپدیت کن
        await loadKholasehList();
        // و اگر میخوای همان تگ را از DB دوباره بگیری:
            ...
            <div className="w-full h-screen flex bg-gray-100 font-sans overflow-hidden shabnam">
                ...
                <div className="w-[30%] h-full bg-white flex flex-col shadow-lg z-10 m-0 p-0">
                    ...
                    >
                        ...
                        <div className="absolute bottom-2 right-2 z-30 flex items-center gap-1 bg-white/90 rounded-lg shadow border border-gray-200 p-1">
                            ...
                            <div className="px-2 text-xs text-gray-700 min-w-[56px] text-center">
                ...
                <div className="w-[70%] h-full flex flex-col m-0 p-0">
                    ...
                    <div className="flex-1 p-2 flex flex-col overflow-hidden gap-2">
                        {/* TextArea */}
                        <div data-tour="textarea-section" className="bg-white rounded-xl shadow border border-gray-200 p-4 flex-[0_0_52%] min-h-0 flex flex-col overflow-hidden relative">
                            {loadingByTag && (

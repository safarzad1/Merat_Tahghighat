...
export async function POST(req: NextRequest) {
    ...
    const { id, shomarehParvandeh, codeEntekhabat
    ...
    try {
        ...
        const result = await pool
            ...
            .input("TagSalahiyat", sql.Int, tagSalahiyat)
            .input("KholasehMatlab", sql.NVarChar(3500), kholasehMatlab)
            .input("CreateUserId", sql.BigInt, createUserId)
            .execute("Davtalab.SP_InsertAshkhasKholasehSalahiyat");
